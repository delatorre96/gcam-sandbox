...
aglu.MODEL_PRICE_YEARS      <- 2008:2010 # consistent with aglu.MODEL_SUA_MEAN_PERIODS
aglu.MODEL_MACRONUTRIENT_YEARS <- 2008:2010   # consistent with aglu.MODEL_SUA_MEAN_PERIODS; FAO only has data for after 2010
aglu.MODEL_COST_YEARS       <- 2008:2010
aglu.DEFLATOR_BASE_YEAR     <- MODEL_FINAL_BASE_YEAR      # year used as the basis for computing regional price deflators
aglu.FALLOW_YEARS           <- 2008:2010 # Years used for calculating the % of fallow land
...
aglu.BIO_START_YEAR         <- MODEL_FUTURE_YEARS[1]       # Also set in aglu/A_bio_ghost_share
...
emissions.UNCONVENTIONAL.OIL.FUG.N2O.EMFACT <- 0.000000939
  ...
  # Time
  emissions.CEDS_YEARS              <- 1970:MODEL_FINAL_BASE_YEAR           # Year coverage for CEDS inventory.

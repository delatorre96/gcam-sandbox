...
module_energy_L2323.iron_steel <- function(command, ...) {
  ...
  if(command == driver.DECLARE_INPUTS) {
    ...
    # ====================================================================
    if (MODEL_FINAL_BASE_YEAR < 2015){
      TZ_steel_production_costs_2010 <- TZ_steel_production_costs[TZ_steel_production_costs$Model_Year == 2015, ]
      TZ_steel_production_costs_2010$Model_Year <- 2010
      TZ_steel_production_costs <- bind_rows(TZ_steel_production_costs_2010,TZ_steel_production_costs)
    }

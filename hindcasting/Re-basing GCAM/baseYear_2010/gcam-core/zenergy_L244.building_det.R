...
module_energy_L244.building_det <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    } else if (max_income_hist_year > MODEL_FINAL_BASE_YEAR){
      income_shares_2015 <- L144.income_shares[L144.income_shares$year == 2015, ]
      income_shares_2015_ssp1 <- income_shares_2015
      income_shares_2015_ssp1$scen[income_shares_2015_ssp1$scen == "Historical data"] <- "SSP1"
      income_shares_2015_ssp2 <- income_shares_2015
      income_shares_2015_ssp2$scen[income_shares_2015_ssp2$scen == "Historical data"] <- "SSP2"
      income_shares_2015_ssp3 <- income_shares_2015
      income_shares_2015_ssp3$scen[income_shares_2015_ssp3$scen == "Historical data"] <- "SSP3"
      income_shares_2015_ssp4 <- income_shares_2015
      income_shares_2015_ssp4$scen[income_shares_2015_ssp4$scen == "Historical data"] <- "SSP4"
      income_shares_2015_ssp5 <- income_shares_2015
      income_shares_2015_ssp5$scen[income_shares_2015_ssp5$scen == "Historical data"] <- "SSP5"
      L144.income_shares <- L144.income_shares[L144.income_shares$year != 2015, ]
      L144.income_shares <- bind_rows(L144.income_shares,
                                      income_shares_2015_ssp1,
                                      income_shares_2015_ssp2,
                                      income_shares_2015_ssp3,
                                      income_shares_2015_ssp4,
                                      income_shares_2015_ssp5)
      L144.income_shares <- L144.income_shares[!L144.income_shares$year %in% c(2011,2012,2013,2014), ]
    }
